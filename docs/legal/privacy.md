...
The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at [https://www.onesoftnet.eu.org/](https://www.onesoftnet.eu.org/), unless otherwise defined in this Privacy Policy.
...
Also, SudoBot will store some basic information like Discord username, ID, avatar, etc about other users that are moderated using it, in order to identify them later for various reasons.
