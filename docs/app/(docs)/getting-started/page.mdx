...
<Callout type="info">
    ...
    [@rakinar2](https://discord.com/users/774553653394538506) at Discord. Your
    Discord server should have at least 50 members to be eligible.
</Callout>
...
Or if you want to have logging while in a production enviroment you can run the following:
```bash
