...
openGraph:
  ...
  authors:
    - Ar Rakin
  images: 
    - url: https://docs.sudobot.org/sudobot-v9-9.png
      height: 250
      width: 250
---
...
<Callout type="warning">
   Please note that this release is a breaking change, and you may need to update your extensions and configurations to match the new version. If you have any questions or need help, feel free to ask in our [Discord server](<>{DISCORD_URL}</>)!
</Callout>