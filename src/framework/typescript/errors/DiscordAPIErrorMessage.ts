...
export const DiscordAPIErrorMessage = {
    ...
    20012: "The system is not authorized to perform this action on this application",
    20016: "This action cannot be performed due to slowmode rate limit",
    20018: "Only the owner of this account can perform this action",
    20022: "This message cannot be edited due to announcement rate limits",
    20024: "Under minimum age",
    20028: "The channel the system is writing has hit the write rate limit",
    20029: "The write action the system is performing on the server has hit the write rate limit",
    20031: "The Stage topic, server name, server description, or channel names contain words that are not allowed",
    ...
    30037: "Maximum number of ban fetches has been reached",
    ...
    40002: "The app needs to be verified in order to perform this action",
    40003: "The system is opening direct messages too fast",
    ...
    50009: "Channel verification level is too high for the system to gain access",
    50010: "OAuth2 application does not have a bot",
    50011: "OAuth2 application limit reached",
    50012: "Invalid OAuth2 state",
    50013: "The system lacks permissions to perform that action",
    ...
    50091: "The entity type of the event is different from the entity the system is trying to start the event for",
    50095: "This server is not available in the location of this app's creator",
    ...
    50173: "The system cannot send voice messages in this channel.",
    50178: "The user account must first be verified",
    50600: "The system does not have permission to send this sticker.",
