...
export enum LogEventType {
    ...
    MemberVoiceChannelJoin = "member_voice_channel_join",
    MemberVoiceChannelLeave = "member_voice_channel_leave"
}
...
const LoggingExclusionSchema = z.object({
    ...
    snowflakes: z.array(SnowflakeSchema),
...
export const LoggingSchema = z.object({
    ...
    global_ignored_channels: z.array(SnowflakeSchema).default([]),
    default_enabled: z
        .boolean()
        .default(true)
        .describe(
    ...
    primary_channel: SnowflakeSchema.optional(),
    hooks: z.record(SnowflakeSchema, SnowflakeSchema).default({}),
